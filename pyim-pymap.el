...
(defvar pyim-pymap-duoyinzi-words
  '(("a" "腌臜" "吖啶")
    ...
    ("ba" "峇厘")
    ("bai" "叔伯" "伯颜" "伯特" "伯琮")
    ("ban" "扳子" "扳手" "扳平" "扳机" "扳回" "扳动")
    ("bang" "肩膀" "翅膀" "彩蚌" "臂膀" "膀子" "膀臂")
    ("bao" "龅牙")
    ("bei" "月孛" "摇臂" "胳臂" "断臂" "孛星")
    ("bi" "刘辟" "复辟" "豆皀" "秕子" "泌阳" "辟邪" "俾使" "睥睨" "俾倪" "秘鲁" "贲临" "秕糠" "吡啶")
    ("biao" "嘌呤")
    ("bin" "香槟" "刘玢" "槟子" "槟城")
    ("bing" "主屏" "槟州" "屏息" "屏气" "槟榔" "屏除")
    ("bo" "厌薄" "稀薄" "微薄" "摊薄" "丝柏" "轻薄" "浅薄" "绵薄" "萝卜" "刻薄" "巨擘" "淡薄" "单薄" "超薄" "剥啄" "剥削" "薄幸" "薄晓" "薄雾" "薄田" "剥蚀" "薄弱" "薄情" "剥皮" "薄暮" "薄膜" "薄命" "薄明" "薄面" "剥落" "柏林" "剥离" "薄利" "薄礼" "擘开" "薄技" "擘画" "薄厚" "薄荷" "薄海" "剥夺" "剥掉" "薄地" "薄待" "薄酬" "薄产" "薄暗" "鄙薄")
    ("bu" "座堡" "吴堡" "米堡" "大埔" "堡寨" "堡的" "安瓿")
    ("ca" "喀嚓" "拆毁")
    ("cen" "参差")
    ("cha" "罗刹" "咔嚓" "喀嚓" "梵刹" "刹那")
    ("chai" "支差" "邮差" "信差" "交差" "出差" "差事" "差遣" "差派" "差旅")
    ("chan" "震颤" "惊颤" "单于" "颤栗" "颤抖" "颤动")
    ("chang" "週長" "霓裳" "裳凤")
    ("chao" "征剿")
    ("chen" "匀称" "相称" "可称" "后称" "对称" "沈重" "称职" "称心" "称是" "沈默" "抻面" "沈积" "称多" "称德" "称臣" "不称")
    ("cheng" "之盛" "祐樘" "刘晟" "李晟" "称稱" "丁盛" "盛的" "饼铛")
    ("chi" "一匙" "汤匙" "豆豉" "茶匙")
    ("chong" "辎重" "双重" "三重" "艨艟" "李重" "二重" "多重" "重做" "重组" "重装" "重置" "重整" "重振" "重造" "重载" "重用" "重印" "重阳" "重演" "重修" "重新" "重写" "重现" "重温" "重围" "重塑" "重拾" "重试" "重生" "重申" "重审" "重赛" "重庆" "重启" "重评" "重拍" "重名" "重门" "重来" "重开" "重建" "重获" "重回" "重合" "重估" "重构" "重复" "重覆" "重逢" "重返" "重罚" "重发" "重读" "重叠" "重点" "重的" "重蹈" "重传" "重重" "重播")
    ("chu" "仔畜" "牲畜" "人畜" "禽畜" "牧畜" "李柷" "家畜" "公畜" "耕畜" "褚遂" "畜生" "畜牲" "畜禽" "畜力" "畜类" "畜栏" "畜肥")
    ("chuai" "搋子" "啜饮" "搋面")
    ("chun" "鹌鹑")
    ("ci" "鸬鹚" "兹的" "参差")
    ("cong" "厚熜" "单枞" "枞树")
    ...
    ("dan" "脏彈" "王赡" "黄疸")
    ("dang" "铃铛")
    ("de" "市地" "似地" "少地" "其地" "目地" "猛地" "汉地" "多地" "地做" "地走" "地置" "地在" "地与" "地用" "地学" "地向" "地为" "地委" "地听" "地说" "地矿" "地将" "地对" "地底" "的地" "地的" "地村" "地把" "代地" "北地" "般地")
    ("dei" "总得" "之得" "真得" "又得" "也得" "习得" "我得" "你得" "就得" "还得" "非得" "而得" "都得" "得最" "得之" "得有" "得先" "得太" "得去" "得其" "得很" "得好" "得多" "得宠" "必得")
    ("deng" "真澄" "高澄" "澄清")
    ("di" "中的" "寻的" "目的" "面的" "美的" "的士" "的确" "提溜" "提防" "打的" "标的" "宝坻")
    ("dian" "佃农")
    ("die" "喋喋")
    ("ding" "樱町" "畹町" "虰蛵")
    ("dong" "杨侗" "侗族" "硐室" "恫吓")
    ("dou" "句读")
    ("du" "宗都" "中都" "之都" "于都" "宇都" "性都" "新都" "下都" "武都" "文都" "为都" "望都" "天都" "他都" "首都" "上都" "商都" "迁都" "宁都" "南都" "们都" "留都" "乐都" "军都" "京都" "江都" "建都" "计都" "皇都" "花都" "后都" "国都" "官都" "古都" "故都" "副都" "丰都" "都匀" "都有" "都要" "都统" "都市" "都是" "都山" "都灵" "都兰" "都会" "都护" "都督" "都等" "都的" "都城" "都昌" "东都" "定都" "奠都" "帝都" "等都" "德都" "的都" "大都" "成都" "臣都" "昌都" "安都")
    ("duo" "审度" "驮子" "哆嗦" "哆啦" "揣度")
    ("e" "吟哦" "飞蛾" "阿谀" "噁心" "噁嗪" "阿难" "蛾类" "阿胶" "阿附" "哦哦" "阿堵" "东阿")
    ("ei" "诶诒" "诶笑")
    ("en" "嗯嗯" "嗯啊")
    ("fa" "砝码" "酦酵")
    ("fei" "米芾")
    ("fen" "自焚" "刘玢" "焚书" "焚烧" "坋粒" "焚毁")
    ("feng" "焚书")
    ("fu" "果脯" "仿佛")
    ("ga" "伽马" "咖喱" "呷呷")
    ("gai" "蓋兹" "芥兰" "芥蓝")
    ...
    ("guo" "絮聒" "聒噪" "涡阳" "聒耳")
    ("ha" "虾夷" "蛤蟹" "蛤蟆")
    ("hai" "宗还" "中还" "这还" "也还" "我还" "她还" "他还" "它还" "谁还" "上还" "人还" "却还" "您还" "你还" "那还" "里还" "还真" "还找" "还曾" "还早" "还在" "还远" "还有" "还用" "还应" "还以" "还要" "还需" "还须" "还行" "还小" "还像" "还想" "还嫌" "还问" "还未" "还为" "还望" "还玩" "还挺" "还算" "还说" "还是" "还剩" "还少" "还让" "还去" "还请" "还怕" "还能" "还没" "还来" "还快" "还可" "还看" "还叫" "还将" "还会" "还很" "还和" "还好" "还贵" "还给" "还高" "还敢" "还多" "还对" "还得" "还带" "还大" "还差" "还不" "还被" "还把" "放还" "帝还" "倒还" "但还")
    ("hang" "总行" "转行" "中行" "支行" "这行" "招行" "在行" "银行" "一行" "央行" "巡行" "我行" "外行" "投行" "同行" "太行" "世行" "生行" "商行" "人行" "排行" "农行" "内行" "闵行" "每行" "两行" "跨行" "交行" "建行" "几行" "换行" "行中" "行长" "行在" "行营" "行业" "桁杨" "行幸" "行数" "行署" "行市" "行省" "行情" "行列" "行家" "行货" "行会" "行规" "行的" "行当" "工行" "港行" "该行" "改行" "分行" "懂行" "车行" "本行")
    ("hao" "貉子" "蚝油" "貉绒" "镐京")
    ("he" "有颌" "下颌" "无颌" "威吓" "上颌" "恐吓" "回纥" "吓声" "阖闾" "阖庐" "阖家" "隔阂" "恫吓")
    ("heng" "桁梁" "桁架" "道行")
    ("hu" "诈唬" "吓唬" "丝核" "菌核" "回鹘" "和牌" "核菌")
    ("huan" "朱鹮" "苋菜")
    ("hui" "讌會" "秦桧")
    ("hun" "珲春")
    ("huo" "罪和" "组和" "宗和" "子和" "字和" "庄和" "州和" "值和" "者和" "战和" "寨和" "在和" "元和" "又和" "营和" "义和" "岩和" "性和" "孝和" "险和" "为和" "王和" "团和" "廷和" "条和" "田和" "特和" "所和" "孙和" "斯和" "税和" "书和" "兽和" "氏和" "是和" "室和" "上和" "权和" "求和" "清和" "戚和" "暖和" "年和" "罗和" "林和" "力和" "克和" "军和" "局和" "搅和" "将和" "奖和" "家和" "机和" "和最" "和周" "和州" "和中" "和之" "和赵" "和张" "和在" "和元" "和与" "和有" "和议" "和以" "和伊" "和一" "和新" "和萧" "和小" "和西" "和文" "和王" "和外" "和唐" "和省" "和三" "和亲" "和秦" "和其" "和嫔" "和帕" "和暖" "和马" "和罗" "和刘" "和六" "和辽" "和两" "和梁" "和李" "和可" "和晋" "和杰" "和后" "和红" "和合" "和更" "和高" "和副" "和分" "和非" "和反" "和二" "和多" "和对" "和队" "和东" "和帝" "和等" "和的" "和党" "和大" "和村" "和陈" "和不" "和本" "和北" "和被" "会和" "汉和" "国和" "官和" "梗和" "感和" "夫和" "福和" "法和" "灯和" "的和" "党和" "成和" "城和" "搀和" "部和" "拌和")
    ("ji" "自给" "箕子" "给予" "给与" "奇羡" "奇袭" "给水" "奇数" "奇偶" "奇尼" "给付" "光奇" "供给" "扶箕" "补给" "簸箕" "畚箕")
    ("jia" "雪茄" "沦浃" "茄克")
    ("jian" "轩槛" "槛车")
    ("jiang" "招降" "再降" "下降" "天降" "霜降" "升降" "起降" "迫降" "空降" "倔强" "强嘴" "降职" "降至" "降噪" "降雨" "降压" "降雪" "降下" "降息" "降温" "降为" "降水" "降世" "降生" "降清" "降落" "降临" "降解" "降将" "降价" "降级" "降哥" "降福" "降幅" "降低" "降到" "归降" "沉降" "不降" "被降")
    ("jiao" "追剿" "征剿" "一觉" "咬嚼" "午觉" "温峤" "围剿" "调校" "睡觉" "审校" "清剿" "懒觉" "校准" "校正" "校阅" "校验" "侥幸" "剿灭" "校勘" "觉觉" "剿匪" "校对" "校订" "校的" "检校" "好觉" "倒嚼" "包剿")
    ("jie" "蕴藉" "慰藉" "盘诘" "藉着" "藉口" "桔梗" "仓颉")
    ("jin" "矜持" "骄矜")
    ("jing" "强劲" "刘晟" "李晟" "劲卒" "劲直" "劲挺" "劲射" "劲峭" "劲旅" "劲烈" "劲急" "劲风" "劲敌" "箐村" "劲吹" "劲草" "劲爆" "劲拔" "刚劲")
    ("jiong" "何炅")
    ("ju" "趑趄" "莴苣")
    ("juan" "猪圈" "垫圈")
    ("jue" "主角" "张角" "配角" "名角" "角逐" "角闪" "角色" "角阙" "角力" "角斗" "角抵" "咀嚼")
    ("jun" "朱隽" "象龟" "溥儁")
    ("kang" "扛着")
    ("kao" "犒劳")
    ("ke" "外壳" "脑壳" "空壳" "壳子" "壳牌" "壳幔" "壳口" "壳阶" "壳虫" "借壳" "机壳" "龟壳" "弹壳" "蛋壳" "贝壳")
    ("kuai" "会计" "财会")
    ("kui" "隗嚣" "傀儡")
    ("kuo" "总括" "综括" "赵括" "囊括" "括线" "括弧" "括号" "括毒" "概括" "包括")
    ("la" "世㻋" "落下")
    ("lang" "阆中" "莨菪")
    ("lao" "落汗")
    ("le" "中肋")
    ("lei" "世㻋" "帕勒" "勒姆" "勒莫" "勒紧" "福勒" "富勒")
    ("leng" "绥棱" "穆棱" "模棱" "棱锥" "棱柱" "棱台" "棱镜" "棱角")
    ("lia" "这俩" "咱俩" "我俩" "他俩" "俩人")
    ("liang" "咱俩" "雅靓" "靓照" "靓仔" "靓颖" "靓女" "靓妹" "靓丽" "伎俩" "技俩")
    ("liao" "知了" "未了" "末了" "明了" "了事" "了然" "了却" "了了" "蓼蓝" "了解" "了结" "了断" "了得" "潦倒" "潦草" "多了" "得了" "不了" "罢了")
    ("lin" "拎着")
    ("liu" "水陆" "陆贽" "陆励" "陆凯" "常陆")
    ("long" "泷泽" "泷船")
    ("lou" "泄露" "露馅" "露面" "露脸" "露出")
    ("lu" "蔗露" "展露" "雨露" "泄露" "泻露" "显露" "外露" "吐露" "透露" "霜露" "曝露" "披露" "面露" "蜜露" "梦露" "裸露" "露珠" "露营" "露西" "露茜" "露天" "露体" "露台" "露宿" "露水" "露面" "露露" "六合" "露韩" "露骨" "露点" "露出" "六安" "流露" "揭露" "寒露" "甘露" "带露" "出露" "初露" "陈露" "不露" "表露" "暴露" "白露" "败露")
    ("luan" "娈童")
    ("lun" "绦纶" "腈纶" "涤纶" "丙纶")
    ("luo" "漯河")
    ("lv" "棕闾" "阖闾")
    ("ma" "抹布" "干麼" "干麽")
    ("man" "滋蔓" "藤蔓" "苏蔓" "埋怨" "蔓延" "埋入" "蔓菁" "蔓草")
    ("mang" "蟒蛇" "巨蟒")
    ("mao" "铆接" "铆工" "铆钉" "玳瑁")
    ("me" "这麼" "这麽" "什麼" "什麽" "那麽")
    ("mei" "谜儿")
    ("mi" "糜烂")
    ("mian" "渑池")
    ("mo" "隐没" "淹没" "吞没" "潜没" "没药" "没收" "嬷嬷" "没落" "埋没" "沦没" "浸没" "覆没" "出没" "沉没")
    ("mu" "牟羽" "姥爷" "模样" "牟平" "模具" "模板" "超模")
    ("na" "谢娜" "王娜" "娜娜" "娜的" "琳娜" "丽娜" "李娜" "厉娜" "多娜" "狄娜" "安娜")
    ("nao" "孬种")
    ("ne" "声呐" "哪吒")
    ("nei" "那种" "那张" "那位" "那天" "那台" "那家" "那个" "那次" "那边")
    ("ni" "去呢" "呢喃")
    ("nian" "粘液" "粘性" "粘土" "粘贴" "粘帖" "粘痰" "粘粘" "粘膜" "粘胶" "粘度" "粘稠" "胶粘")
    ("nie" "蘖枝")
    ("niu" "执拗")
    ("nu" "内帑")
    ("o" "哦哟" "哦哦" "你哦" "好哦")
    ...
    ("ping" "冯异" "冯剑" "冯保")
    ("po" "王朴" "朴子" "泊头" "朴茨" "湖泊")
    ("pu" "座堡" "堡寨" "曝露" "曝光" "堡的" "米堡")
    ("qi" "侦缉" "焉耆" "槭木" "鮨科" "蒲圻" "会稽" "菜畦" "荸荠")
    ("qia" "哨卡" "卡洛" "髂骨" "卡队" "卡迪" "卡的" "洛卡" "和卡" "菲卡" "尔卡" "的卡" "博卡")
    ("qian" "犍为" "纤纤" "蕁麻" "纤夫" "光纤")
    ("qiang" "自戕" "羟基" "戕害" "箐村")
    ("qiao" "叶鞘" "雪橇" "温峤" "髓鞘" "躯壳" "雀子" "鞘脂" "壳质" "壳牌" "壳口" "壳阶" "壳虫" "甲壳" "地壳" "刀鞘" "冰橇")
    ("qing" "血亲" "亲家" "箐村")
    ("qiu" "象龟" "仇士" "仇和")
    ("qu" "蠼螋" "區旗")
    ("que" "乙炔")
    ...
    ("sa" "灑脱")
    ("sai" "鳃裂")
    ("se" "阻塞" "淤塞" "拥塞" "血塞" "填塞" "搪塞" "栓塞" "塞罗" "梗塞" "堵塞" "杜塞" "出塞" "充塞" "闭塞" "鼻塞")
    ("sha" "手刹" "上杉" "刹住" "刹车" "刹把")
    ("shai" "褪色" "套色" "色子" "本色")
    ("shan" "王赡" "受禅" "赡养" "单县" "禅位" "禅寺" "单生" "禅让" "单桨" "单福" "单发" "禅定" "单超" "掸邦" "人单" "栏栅" "光栅" "格栅" "封禅" "的单")
    ("shang" "羹汤")
    ("shao" "叶鞘" "杓子" "召入" "召来" "召到")
    ("she" "畲族" "歙县" "折钱" "阇梨" "折可" "折耗" "折秤" "折本" "和折" "瞽阇")
    ("shei" "有谁" "是谁" "谁知" "谁有" "谁又" "谁也" "谁要" "谁说" "谁是" "谁人" "谁让" "谁能" "谁来" "谁就" "谁家" "谁会" "谁都" "谁的")
    ("shen" "桑椹" "妊娠")
    ("sheng" "刘晟" "李晟")
    ("shi" "钥匙" "乌什" "通什" "殖质" "什叶" "什邡" "似的" "似地" "纳什" "喀什" "好似" "腐殖" "繁峙" "豆豉" "布什" "波什" "奥什")
    ("shou" "煮熟" "熟语" "腐熟" "成熟" "常熟")
    ("shu" "數周" "腧穴")
    ("shuang" "泷水")
    ("shui" "游说" "说客" "说服")
    ("si" "同食" "食邑" "伺隙" "伺机" "伺服" "食材" "服食")
    ("sou" "咳嗽")
    ("su" "李愬")
    ("sui" "绥中" "绥阳" "尿样" "浽溦" "绥宁" "绥蒙" "绥棱" "绥靖" "绥江" "绥化" "绥德" "绥滨" "晋绥" "扶绥")
    ("suo" "羧酸" "羧基")
    ("ta" "杂沓" "拖沓" "拓印" "拓片" "蛋挞" "鞭挞")
    ("tan" "弹奏" "弹指" "弹压" "弹牙" "弹性" "弹匣" "弹跳" "弹射" "弹琴" "弹力" "弹纠" "弹簧" "弹花" "弹劾" "弹词" "弹出" "弹斥" "弹唱" "弹拨" "手弹" "枪弹" "难弹" "乱弹" "反弹" "动弹")
    ("tang" "祐樘")
    ("tao" "洮南" "临洮")
    ("tiao" "征调" "协调" "下调" "微调" "调制" "调至" "调整" "调匀" "调音" "调养" "调驯" "调休" "调性" "调校" "调戏" "调温" "调味" "调停" "调速" "调试" "调情" "调频" "调皮" "调配" "调门" "调料" "调理" "调来" "调控" "调侃" "调节" "调解" "调教" "调价" "调剂" "调回" "调和" "调好" "调羹" "调高" "调队" "调低" "调的" "调到" "调处" "调成" "特调" "失调" "上调" "区调" "烹调" "联调" "空调" "可调" "回调" "汉调" "宫调" "不调")
    ("tie" "呫嗫" "呫哔" "呫毕" "嗫呫")
    ("ting" "樱町" "室町")
    ("tong" "杨侗" "洪洞")
    ("tou" "骰子")
    ...
    ("tuo" "驮兽")
    ("wan" "莞尔" "苏蔓")
    ("wei" "中尉" "校尉" "隗嚣" "卫尉" "尉氏" "廷尉" "太尉" "浽溦" "少尉" "上尉" "都尉")
    ("wen" "李玟")
    ("weng" "蕹菜")
    ("wo" "蜗蜒" "蜗旋" "蜗行" "喔喔" "蜗牛" "蜗庐" "蜗居" "耳蜗")
    ("wu" "憎恶" "厌恶" "嫌恶" "唔知" "唔系" "唔好" "可恶" "恨恶")
    ("xi" "栖霞" "腊味" "鸂鶒" "水螅" "勐腊" "露茜" "的腊")
    ("xia" "陜西" "厦门" "厦华" "厦大")
    ("xian" "纤芯" "纤小" "閒暇" "纤细" "纤维" "纤体" "閒谈" "纤弱" "纤巧" "纤毛" "閒混" "閒话" "纤度" "苋菜" "秋狝" "化纤" "光纤" "安閒")
    ("xiang" "李愬")
    ("xie" "吸血" "吐血" "的血" "出血" "仓颉" "便血")
    ("xin" "奕䜣" "莘庄")
    ("xing" "自省" "荥阳" "省悟" "省视" "省亲" "省察" "井陉" "反省")
    ("xiu" "一宿" "宿命" "宿存" "星宿" "参宿")
    ("xu" "畜牧" "戌狗" "戊戌" "壬戌" "牧畜" "甲戌" "庚戌" "丙戌")
    ("xuan" "乾癣")
    ("xue" "削职" "谑语" "谑戏" "噱头" "削弱" "削去" "削平" "谑剧" "削减" "削藩" "削夺" "谐谑" "戏谑" "瘦削" "磨削" "剥削")
    ("xun" "张浚" "荨麻" "香蕈" "毒蕈")
    ("ya" "枝桠" "轧染" "轧棉" "轧场" "倾轧" "琅琊")
    ("yan" "芫荽" "湮灭" "菸碱" "菸硷" "菸蒂" "屋檐" "刘縯" "抽菸")
    ("yang" "张卬")
    ("yao" "钟繇" "锺繇" "约塔" "幺二" "么点" "星曜" "对幺")
    ("ye" "呜咽" "琅邪" "琅琊" "琅玡" "哽咽")
    ("yin" "湮灭" "吲哚" "牙龈" "齿龈")
    ("ying" "荥经")
    ("you" "钟繇")
    ("yu" "蔚县" "俞夏")
    ("yuan" "芫花" "胡芫" "雇員")
    ("yue" "奏乐" "钟乐" "乐之" "乐章" "乐音" "乐团" "乐坛" "乐手" "乐师" "乐曲" "乐清" "乐器" "乐谱" "乐迷" "乐经" "乐工" "乐府" "乐队" "音乐" "阎乐" "雅乐" "弦乐" "声乐" "器乐" "配乐" "民乐" "密钥" "礼乐" "胡乐" "国乐" "哀乐" "爱乐")
    ("yun" "筠连")
    ("za" "扎囊" "塔扎" "包扎" "腌臜")
    ("zai" "甾酮")
    ("zan" "攒钱" "积攒")
    ("zang" "藏族" "藏语" "藏文" "藏人" "藏区" "藏民" "藏羚" "藏独" "藏獒" "援藏" "玄奘" "西藏" "搜藏" "青藏" "进藏" "滇藏" "地藏" "道藏" "川藏" "宝藏")
    ("zao" "凿子" "凿枘" "凿空" "凿井" "榫凿" "确凿" "开凿")
    ("zeng" "中曾" "曾祖" "曾孙" "曾随" "曾山" "曾巩" "曾哥" "曾布" "特曾" "他曾" "克曾" "还曾")
    ("zha" "轧制" "柞水" "轧机" "轧钢" "热轧" "冷轧")
    ("zhai" "祭天" "翟凌" "祭礼")
    ("zhan" "粘在" "粘贴" "粘连" "呫吨")
    ("zhang" "尊长" "组长" "族长" "总长" "滋长" "状长" "助长" "州长" "至长" "镇长" "长子" "长姊" "长者" "长着" "长在" "长圆" "长兄" "长相" "长孙" "长势" "长史" "长肉" "长庆" "长片" "长胖" "长女" "长毛" "长满" "长吏" "长了" "长老" "长进" "长兼" "长官" "长高" "长冈" "长而" "长的" "长得" "长到" "长大" "长出" "长成" "长辈" "站长" "增长" "在长" "院长" "园长" "营长" "议长" "学长" "兄长" "信长" "斜长" "校长" "消长" "乡长" "县长" "外长" "团长" "厅长" "庭长" "台长" "所长" "司长" "水长" "首长" "市长" "师长" "生长" "省长" "社长" "色长" "区长" "酋长" "庆长" "排长" "年长" "旅长" "刘长" "连长" "了长" "科长" "军长" "局长" "警长" "见长" "舰长" "家长" "机长" "或长" "会长" "行长" "光长" "馆长" "二长" "队长" "店长" "等长" "的长" "道长" "大长" "村长" "次长" "船长" "处长" "成长" "车长" "厂长" "财长" "部长" "不长" "班长")
    ("zhao" "宗朝" "朝之" "朝政" "找着" "嘲哳" "朝有" "朝阳" "爪牙" "着想" "朝霞" "朝夕" "爪哇" "着手" "朝时" "朝气" "着魔" "着迷" "着忙" "着落" "着陆" "着凉" "着紧" "朝见" "着急" "着火" "朝晖" "朝会" "着慌" "朝贡" "着法" "朝的" "朝臣" "着边" "早朝" "一朝" "睡着" "视朝" "失着" "上朝" "阮朝" "入朝" "明朝" "辽朝" "李朝" "历朝" "累朝" "了朝" "来朝" "今朝" "金朝" "得着" "的朝" "当朝" "陈朝" "不着")
    ("zhe" "褶皱" "苏辙" "没辙" "故辙" "覆辙")
    ("zheng" "魏徵")
    ("zhi" "栉比" "月氏" "魏徵" "王珪" "标识")
    ("zhou" "钟繇")
    ("zhu" "褚遂" "苎麻" "白术")
    ("zhuan" "左传" "自传" "传至" "传赞" "传位" "传略" "传记" "重传" "小传" "侠传" "外传" "史传" "盛馔" "前传" "列传" "假传" "记传")
    ("zhuang" "一幢")
    ("zhun" "屯田" "屯村" "屯兵" "驻屯" "家屯")
    ("zhuo" "着装" "着重" "着意" "着眼" "缴销" "着想" "着手" "着实" "着色" "着棋" "着墨" "着落" "着陆" "着力" "着床" "着处" "着笔" "执着" "预缴" "衣着" "吸着" "身着" "黏着" "免缴" "扣缴" "附着" "穿着" "沉着" "剥啄")
    ("zi" "仔猪" "仔细" "仔姜" "仔畜" "华仔" "狗仔" "产仔")
    ("zong" "枞阳" "厚熜")
    ("zu" "顇奴" "菹醢")
    ("zuan" "赚钱")
    ("zuo" "琢磨" "枘凿" "酬酢"))
