...
;; * 說明文檔                                                              :doc:
;; 這個文件是 pyim 內部使用的 "拼音-漢字" 對照表，
;; 這個對照表用來實現拼音查詢功能，即，查詢某個漢字對應的拼音代碼。

;; 注意： 這個文件 *不用於* 輸入法自定義詞庫！！！
...
第一個元素為拼音，第二個元素為拼音對應的漢字組成的字元串，字元串
中漢字按照使用頻率排序， “|” 之前的漢字為3500個常用漢字")
