...
(defvar pyim-pymap-duoyinzi-words
  '(("a" "阿姨" "阿富" "阿门" "阿拉" "阿林" "黑阿" "麦阿密" "鹿城阿岙" "阿福")
    ...
    ("bai" "叔伯" "百万")
    ("bao" "剥皮" "超薄" "薄脆" "薄板" "薄饼" "暴晒" "暴发" "暴雨" "暴力" "风暴" "暴露" "暴风" "汉堡" "古堡" "地堡" "城堡" "龍堡" "卡斯堡" "麻家堡" "麦芬堡" "汉堡" "麦得堡" "麦尔堡" "曝光" "瀑河")
    ("beng" "蚌埠")
    ("bi" "复辟" "臂章" "螳臂" "交臂" "前臂" "一臂" "奋臂" "膀臂" "臂膀" "秘鲁" "泌阳")
    ("bing" "屏弃" "屏气" "屏除" "屏退" "屏息")
    ("bian" "扁桃" "方便" "方便面" "便当" "便捷")
    ("bo" "薄荷" "单薄" "伯仲" "伯乐" "伯劳" "伯父" "大伯" "老伯" "伯母" "黄伯" "伯爵" "停泊" "淡泊" "尼泊" "漂泊" "鸿波" "柏林")
    ("bu" "大埔")
    ("can" "参谋" "参事" "总参" "参数" "参议" "参观" "参拜" "参股")
    ("cang" "埋藏" "藏头" "秘藏" "雪藏" "藏匿" "收藏" "馆藏" "矿藏" "隐藏" "蕴藏" "藏袍" "储藏" "窖藏" "藏龙" "藏胞" "冷藏" "珍藏" "私藏" "藏掖" "西藏" "藏书" "藏品" "伧俗" "龙藏寺")
    ("cen" "参差")
    ("ceng" "不曾" "似曾" "几曾" "何曾" "曾经" "曾几" "未曾" "噌的" "一声")
    ("cha" "刹那" "宝刹" "一刹" "喳喳")
    ("chai" "公差" "差役" "专差" "官差" "听差" "美差" "办差" "差事" "差使" "肥差" "当差" "钦差")
    ("chan" "颤悠" "单于" "禅学" "班禅" "禅宗" "禅堂" "禅门" "禅机" "禅杖" "禅房" "禅师" "坐禅" "参禅" "禅院")
    ("chang" "周长" "细长" "长发" "三长" "长河" "长袖" "长衫" "天长" "长短" "超长" "长沙" "长春" "长远" "长度" "长江" "长处" "长假" "长街" "长征" "全长" "长城" "波长" "身长" "长途" "长吁" "长虹" "长方")
    ("chao" "朝阳" "朝阳区" "朝鲜" "朝廷" "王朝" "历朝" "解嘲" "讥嘲" "自嘲" "嘲笑" "嘲弄" "冷嘲" "嘲讽" "绰绰" "绰起" "绰家" "剿袭" "剿说")
    ("che" "汽车" "停车场" "车车" "黑车" "车饰")
    ("chen" "称职" "匀称" "称心" "相称" "对称")
    ...
    ("chong" "重庆" "重重")
    ("chou" "汗臭" "臭氧" "口臭" "腋臭" "臭虫" "臭骂" "臭美" "酸臭" "腐臭" "臭气" "腥臭" "臭名" "遗臭" "恶臭" "臭豆" "狐臭" "臭味" "臭架")
    ("chuang" "经幢")
    ("chuo" "绰约" "阔绰" "绰号" "宽绰")
    ("ci" "参差" "伺候" "龟兹")
    ("cuan" "攒钱" "攒聚" "攒动")
    ...
    ("dai" "大夫")
    ("dan" "西单" "东单" "清单" "报单" "单利" "名单" "单姓" "单亲" "单线" "单科" "单间" "单挑" "单价" "单词" "子弹")
    ("de" "似的" "总的" "中的" "别的")
    ("deng" "澄清")
    ("di" "怎的" "无的" "有的" "目的" "标的" "打的" "的确" "的当" "的士" "上地" "大地" "天地" "提防")
    ("diao" "蓝调" "蓝调吧" "调调" "音调" "论调" "格调" "调令" "低调" "笔调" "基调" "强调" "声调" "滥调" "老调" "色调" "单调" "腔调" "跑调" "曲调" "步调" "语调" "主调" "情调")
    ("du" "都会" "国都" "都城" "古都" "故都" "大都" "首都" "成都" "旧都" "都市" "龙都" "鼎都" "鹤都" "鹏都" "鸿都" "麦度" "态度" "读书" "法度" "宽度" "进度")
    ("dou" "全都" "句读")
    ("duo" "测度" "忖度" "揣度" "猜度")
    ("dun" "粮囤")
    ("e" "阿谀" "阿胶" "阿弥" "恶心")
    ...
    ("hai" "还是" "还有")
    ("hao" "貉子" "貉绒")
    ("hang" "总行" "分行" "支行" "行业" "排行" "行情" "央行" "农行" "建行" "商行" "外行" "银行" "商行" "酒行" "麻行" "琴行" "巷道")
    ...
    ("hong" "红装" "红牌" "红木" "红人")
    ("huo" "软和" "热和" "暖和")
    ("ji" "病革" "给养" "自给" "给水" "薪给" "给予" "供给" "稽考" "稽查" "稽核" "滑稽" "稽留" "缉获" "缉查" "缉私" "缉捕" "狼藉" "奇数" "亟待" "亟须" "亟亟" "亟需" "诘屈" "荠菜")
    ("jia" "雪茄" "瑜伽" "伽利略")
    ("jian" "龙见")
    ...
    ("jv" "咀嚼" "趑趄")
    ("jvan" "猪圈" "羊圈")
    ("jue" "主角" "角色" "旦角" "女角" "丑角" "角力" "名角" "配角" "咀嚼" "直觉" "感觉" "错觉" "触觉" "幻觉")
    ("jun" "龟裂")
    ("jvn" "龟裂")
    ("ka" "咖啡" "磁卡" "贺卡" "卡拉" "胸卡" "声卡" "卡片" "绿卡" "卡通" "网卡" "卡口" "龙卡" "咯痰" "咯血")
    ...
    ("lu" "绿林")
    ("luo" "络腮" "部落" "落花" "日落")
    ("lv" "频率" "机率" "比率" "效率" "胜率" "概率" "汇率" "功率" "倍率" "绿叶" "淡绿" "绿色" "绿豆" "伛偻" "绿洲")
    ("lun" "丙纶" "锦纶" "经纶" "涤纶")
    ("man" "埋怨")
    ...
    ("ping" "屏幕" "荧屏" "银屏")
    ("po" "朴刀")
    ("pu" "暴十" "一曝十寒" "里堡" "十里堡" "胸脯" "肉脯" "脯子" "杏脯" "简朴" "朴质" "古朴" "朴厚" "纯朴" "朴素" "诚朴" "俭朴" "朴实" "淳朴" "曝晒" "瀑布" "飞瀑" "黄埔")
    ("qiu" "龟兹")
    ...
    ("shi" "钥匙" "拾荒" "捡拾" "拾物" "家什" "什物" "什锦" "麻什" "麦什" "喀什" "牛什" "见识" "知识" "似的" "骨殖" "饮食" "副食" "石业" "石头" "石艺" "姓氏" "上栅" "下栅")
    ("shuai" "表率" "率性" "率直" "率真" "粗率" "率领" "轻率" "直率" "草率" "大率" "坦率" "数字" "招数" "基数" "数码")
    ("shuang" "泷水")
    ("shu" "金属" "气数" "岁数" "度数" "数据" "级数" "数控" "数学" "参数" "次数" "正数" "代数" "实数" "系数" "分数" "辈数")
    ("shui" "游说")
    ("shuo" "数见" "数见不鲜" "传说" "听说" "妄说" "实说" "胡说" "评说" "分说" "小说")
    ("si" "窥伺" "伺弄" "伺机" "疑似" "似是" "好似" "似曾" "形似" "酷似" "貌似" "似懂" "胜似" "恰似" "近似" "神似" "赛似" "看似" "活似" "强似" "似乎" "类似" "相似")
    ...
    ("tun" "囤积" "囤聚")
    ("wei" "响尾" "尾巴" "尾灯" "船尾" "追尾" "尾椎" "月尾" "燕尾" "尾数" "年尾" "岁尾" "鸢尾" "凤尾" "彗尾" "尾翼" "结尾" "遗之" "龙尾" "齐鑫尾" "麻尾" "麦度" "鹿尾")
    ("wu" "可恶" "交恶" "好恶" "厌恶" "憎恶" "嫌恶" "痛恶" "深恶")
    ("wan" "藤蔓" "枝蔓" "瓜蔓" "蔓儿" "莞尔" "百万")
    ("xia" "虾仁" "青虾" "大虾" "虾皮" "对虾" "虾子" "虾酱" "虾兵" "虾米" "龙虾" "噶厦" "厦门" "吓唬" "吓人" "惊吓" "天虾" "龙虾" "皮皮虾" "麦虾")
    ("xi" "栖栖" "关系" "星系" "水系" "系念" "体系" "联系" "系列" "菜系" "世系" "蹊径")
    ("xiao" "学校" "切削" "削面" "刀削" "刮削")
    ("xian" "纤细" "光纤" "纤巧" "纤柔" "纤小" "纤维" "纤瘦" "纤纤" "化纤" "纤秀" "棉纤" "纤尘")
    ("xiang" "街巷" "僻巷" "巷子" "龙门巷" "六巷" "龙湾巷" "龙港巷" "龙泉巷" "龙巷" "龙妙巷" "龄巷" "齐家巷" "鼓楼巷" "鼓巷" "黎明巷" "麻子巷" "麻园巷" "麦子巷" "鹊巷")
    ("xie" "解数" "出血" "采血" "换血" "血糊" "尿血" "淤血" "放血" "血晕" "血淋" "便血" "吐血" "咯血" "叶韵" "蝎子")
    ("xiu" "铜臭" "乳臭" "成宿" "星宿")
    ("xin" "鸿信")
    ("xing" "深省" "省视" "内省" "不省人事" "省悟" "省察" "旅行" "例行" "行程" "行乐" "龙行" "不行" "也行" "很行" "人行" "流行" "先行" "行星" "品行" "发行" "行政" "风行" "龙行" "龍行" "麟行")
    ("xu" "牧畜" "畜产" "畜牧" "畜养" "气吁" "喘吁" "吁吁" "麦埂圩")
    ("xue" "削减" "削弱" "削瘦" "削球" "削平" "削价" "瘦削" "剥削" "削职" "删削" "削肩" "吸血")
    ("xun" "荨麻" "荨麻疹")
    ("yao" "发疟" "疟子" "约斤" "称约" "钥匙" "金钥")
    ("yan" "吞咽" "咽气" "咽喉" "殷红" "腌制" "腌肉" "腌菜" "烟草" "名烟" "烟酒")
    ("ye" "抽咽" "哽咽" "咽炎" "下咽" "呜咽" "幽咽" "悲咽" "绿叶" "叶子" "荷叶" "落叶" "菜叶" "红叶" "树叶" "枫叶" "茶叶" "鸿葉")
    ("yi" "自艾" "惩艾" "后尾")
    ("yin" "殷勤" "殷墟" "殷切" "殷鉴")
    ("yo" "杭育")
    ("yu" "谷浑" "呼吁" "吁请" "吁求" "体育" "教育" "育儿" "熨帖" "熨烫")
    ("yun" "熨斗" "电熨斗")
    ("yue" "乐音" "器乐" "乐律" "乐章" "音乐" "乐理" "民乐" "乐队" "声乐" "奏乐" "弦乐" "乐坛" "管乐" "配乐" "乐曲" "乐谱" "锁钥" "密钥" "乐团" "鼓乐社" "乐器" "栎阳" "约会")
    ("zan" "积攒")
    ...
    ("zha" "马扎" "挣扎" "扎啤" "扎根" "扎手" "扎针" "扎花" "扎堆" "扎营" "扎实" "稳扎" "柞水" "麻扎镇" "麻扎乡" "栅栏")
    ("zhai" "择菜")
    ("zhan" "不粘" "粘贴" "粘连")
    ("zhao" "朝朝" "明朝" "朝晖" "朝夕" "朝思" "有朝" "今朝" "朝气" "朝三" "朝秦" "朝霞" "鹰爪" "龙爪" "魔爪" "爪牙" "失着" "着数" "龙爪槐")
    ("zhe" "破折" "打折" "曲折" "折冲" "存折" "折合" "折旧" "折纸" "骨折" "折返" "折价" "折算" "波折" "折扇" "对折" "不折" "折扣" "七折" "折中" "拙著" "要著" "著文" "新著" "本着" "对着")
