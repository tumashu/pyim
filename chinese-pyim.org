              ...
              (setq words (append words
                                  (cdr
                                   (pyim-bisearch-word code
                                                       (point-min)
                                                       (point-max)))))
            (message "%s 可能不是一个有效的词库 buffer，忽略。"
...
#+NAME: functions-setup-and-delete-overlay
#+BEGIN_SRC emacs-lisp :noweb yes
...
#+NAME: functions-show-overlay-and-guidance
#+BEGIN_SRC emacs-lisp :noweb yes
(defun pyim-show ()
...
#+BEGIN_SRC emacs-lisp :noweb yes :tangle chinese-pyim.el
<<functions-setup-and-delete-overlay>>

<<functions-show-overlay-and-guidance>>
