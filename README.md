- [pyim 使用说明](#org57795e6)
  ...
  - [使用](#org5419ab2)
    ...
    - [使用仓颉输入法](#org2a60c11)
    - [让选词框跟随光标](#org8dab324)
    - [调整 tooltip 选词框的显示样式](#org0716f4f)
    - [设置模糊音](#orgfcc336f)
    - [词条获取](#org19f7fda)
    - [切换全角标点与半角标点](#orga4c8d95)
    - [手动加词和删词](#org1445041)
    - [pyim 高级功能](#orgba31ed2)
  - [捐赠](#org4b6fff2)
  - [Tips](#org4e419a3)
    - [如何将个人词条导出到一个文件](#org24cabc2)
    - [pyim 出现错误时，如何开启 debug 模式](#orgf351fad)
    - [选词框弹出位置不合理或者选词框内容显示不全](#org9b40d32)
    - [如何查看 pyim 文档。](#orgabcd21d)
    - [将光标处的拼音或者五笔字符串转换为中文 (与 vimim 的 “点石成金” 功能类似)](#org41eded3)
    - [如何添加自定义拼音词库](#org7404057)
    - [如何手动安装和管理词库](#orgf5cd072)
    - [Emacs 启动时加载 pyim 词库](#org1f76cb0)
    - [将汉字字符串转换为拼音字符串](#org96234fe)
    - [中文分词](#orgc0a5aa6)
    - [获取光标处的中文词条](#orgceb7802)
    - [让 \`forward-word' 和 \`back-backward’ 在中文环境下正常工作](#orge3856df)
    - [为 isearch 相关命令添加拼音搜索支持](#org72fc970)
...
如果 pyim-greatdict 不能满足需求，用户可以使用其他方式为 pyim 添加拼音词库， 具体方式请参考 [1.10.6](#org7404057) 小结。
