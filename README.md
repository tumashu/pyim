- [Chinese-pyim 使用说明](#sec-1)
  ...
  - [使用](#sec-1-7)
    ...
    - [[实验特性] 词语联想](#sec-1-7-6)
  - [Tips](#sec-1-8)
    - [如何添加自定义拼音词库](#sec-1-8-1)
    - [如何手动安装和管理词库](#sec-1-8-2)
    - [将汉字字符串转换为拼音字符串](#sec-1-8-3)
...
用户可以使用三种方法为 Chinese-pyim 添加拼音词库，具体方式请参考 1.8.1 小结。
...
### 如何添加自定义拼音词库<a id="sec-1-8-1" name="sec-1-8-1"></a>
...
### 如何手动安装和管理词库<a id="sec-1-8-2" name="sec-1-8-2"></a>
...
### 将汉字字符串转换为拼音字符串<a id="sec-1-8-3" name="sec-1-8-3"></a>
