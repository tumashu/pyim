...
### 手动加词和删词<a id="sec-1-7-5" name="sec-1-7-5"></a>
...
### 快速切换词库<a id="sec-1-7-6" name="sec-1-7-6"></a>
...
### [实验特性] 词语联想<a id="sec-1-7-7" name="sec-1-7-7"></a>
...
### 选词框弹出位置不合理或者选词框内容显示不全<a id="sec-1-8-1" name="sec-1-8-1"></a>
...
### 如何手动安装和管理词库<a id="sec-1-8-4" name="sec-1-8-4"></a>
...
### 将汉字字符串转换为拼音字符串<a id="sec-1-8-5" name="sec-1-8-5"></a>
