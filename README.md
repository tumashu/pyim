...
1.  [pyim 使用说明](#org932a3dc)
    ...
    7.  [配置](#org69a3509)
        1.  [配置实例](#org5972b8d)
        2.  [添加词库文件](#org21b60b9)
        3.  [激活 pyim](#org99e38a9)
    8.  [使用](#org4e8be12)
        1.  [常用快捷键](#org956534d)
        2.  [使用双拼模式](#orgd80b128)
        3.  [通过 pyim 来支持 rime 所有输入法](#org9bf91c4)
        4.  [使用五笔输入](#orgb157452)
        5.  [使用仓颉输入法](#org1d12f01)
        6.  [让选词框跟随光标](#orgd8518f2)
        7.  [调整 tooltip 选词框的显示样式](#org0c4ca0b)
        8.  [设置模糊音](#orga4d54f5)
        9.  [使用魔术转换器](#org80398d3)
        10. [切换全角标点与半角标点](#orgafdb56c)
        11. [手动加词和删词](#org6d6e63e)
        12. [pyim 高级功能](#org0e98985)
    9.  [捐赠](#orge593807)
    10. [Tips](#org5a3abc8)
        1.  [关闭输入联想词功能 (默认开启)](#org801c5c3)
        2.  [如何将个人词条相关信息导入和导出？](#org84c999d)
        3.  [pyim 出现错误时，如何开启 debug 模式](#org40ad362)
        4.  [如何查看 pyim 文档。](#orgd8fb597)
        5.  [将光标处的拼音或者五笔字符串转换为中文 (与 vimim 的 “点石成金” 功能类似)](#org4f582af)
        6.  [如何使用其它字符翻页](#org64d0985)
        7.  [如何用 ";" 来选择第二个候选词](#org7d7359f)
        8.  [如何添加自定义拼音词库](#orgcb568bc)
        9.  [如何手动安装和管理词库](#org9a81531)
        10. [Emacs 启动时加载 pyim 词库](#org408b245)
        11. [将汉字字符串转换为拼音字符串](#orgc264606)
        12. [中文分词](#org1bfca77)
        13. [获取光标处的中文词条](#org571b25c)
        14. [让 \`forward-word' 和 \`back-backward’ 在中文环境下正常工作](#org2eb4aea)
        15. [为 isearch 相关命令添加拼音搜索支持](#org2f8f6b4)
...
如果 pyim-basedict 不能满足需求，用户可以使用其他方式为 pyim 添加拼音词库，具体方式请参考 [1.10.8](#orgcb568bc) 小结。
...
2.  将 liberime 的 page\_size 设置为 100, 这样 pyim 一次可以获取 100
    个候选词，然后自己处理分页。用户可以按 TAB 键切换到辅助输入法来输入 100 以后的词条。
