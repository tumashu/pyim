...
1.  [pyim 使用说明](#org45f8f7c)
    ...
    7.  [配置](#org11c1b9f)
        1.  [配置实例](#org4c4b9ee)
        2.  [添加词库文件](#org14e0115)
        3.  [激活 pyim](#orge7e743c)
    8.  [使用](#orgaab672c)
        1.  [常用快捷键](#org1bcdc38)
        2.  [使用双拼模式](#org8c784ed)
        3.  [使用 rime 输入法](#orgadf2386)
        4.  [使用五笔输入](#orgceb0e8f)
        5.  [使用仓颉输入法](#orgdeb4f27)
        6.  [使用三码郑码（至至郑码）输入法](#orgbf9177e)
        7.  [让选词框跟随光标](#org90d567b)
        8.  [调整 tooltip 选词框的显示样式](#org8277e75)
        9.  [设置模糊音](#org5ec928e)
        10. [使用魔术转换器](#org0f1f87b)
        11. [切换全角标点与半角标点](#org5ba347a)
        12. [手动加词和删词](#orgbc4345d)
        13. [pyim 高级功能](#orgb900027)
    9.  [捐赠](#org24f9ed2)
    10. [Tips](#org578d2c9)
        1.  [关闭输入联想词功能 (默认开启)](#org1ee138b)
        2.  [如何将个人词条相关信息导入和导出？](#org0436b43)
        3.  [pyim 出现错误时，如何开启 debug 模式](#orgea715e0)
        4.  [如何查看 pyim 文档。](#org242c9ab)
        5.  [将光标处的拼音或者五笔字符串转换为中文 (与 vimim 的 “点石成金” 功能类似)](#org414a2e2)
        6.  [如何使用其它字符翻页](#orga4bc415)
        7.  [如何用 ";" 来选择第二个候选词](#org4d3c58d)
        8.  [如何添加自定义拼音词库](#org1ad646d)
        9.  [如何手动安装和管理词库](#org1986e4c)
        10. [Emacs 启动时加载 pyim 词库](#orge965d22)
        11. [将汉字字符串转换为拼音字符串](#org1db2ed7)
        12. [中文分词](#org959eeee)
        13. [获取光标处的中文词条](#org8693dad)
        14. [让 \`forward-word' 和 \`back-backward’ 在中文环境下正常工作](#orgf9b6583)
        15. [为 isearch 相关命令添加拼音搜索支持](#org12f3e23)
        16. [让 ivy 支持拼音搜索候选项功能](#org9fdaacc)
        17. [让 vertico, selectrum 等补全框架，通过 orderless 支持拼音搜索候选项功能。](#org55d7fdb)
...
如果 pyim-basedict 不能满足需求，用户可以使用其他方式为 pyim 添加拼音词库，具体方式请参考 [1.10.8](#org1ad646d) 小结。
