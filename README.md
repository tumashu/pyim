...
## 配置<a id="org69944e6"></a>

### 配置实例<a id="org47b5a57"></a>
...
### 添加词库文件<a id="org27bff5d"></a>

用户可以使用三种方法为 Chinese-pyim 添加拼音词库，具体方式请参考 [1.10.5](#org8e094f9) 小结。
...
### 激活 Chinese-pyim<a id="orge17d7e5"></a>

    (setq default-input-method "chinese-pyim")
    (global-set-key (kbd "C-\\") 'toggle-input-method)

## 使用<a id="orgc276251"></a>

### 常用快捷键<a id="org2bc01f7"></a>
...
### 调整 tooltip 选词框的显示样式<a id="org1e47a80"></a>
...
### 设置模糊音<a id="orgc405b73"></a>

可以通过设置 \`pyim-fuzzy-pinyin-alist' 变量来自定义模糊音。

### 词语联想<a id="org9720428"></a>
...
### Chinese-pyim 高级功能<a id="org02de9c4"></a>
...
## Tips<a id="org29f29dd"></a>

### Chinese-pyim 出现错误时，如何开启 debug 模式<a id="orgec6bb0c"></a>

    (setq debug-on-error t)

### 选词框弹出位置不合理或者选词框内容显示不全<a id="orgb1ac559"></a>
...
### 将汉字字符串转换为拼音字符串<a id="orgc25f9ff"></a>
...
### 为 isearch 相关命令添加拼音搜索支持<a id="org6b6950c"></a>
...
### 使用 Chinese-pyim 改善 company-mode 中文补全的体验<a id="org3b99e54"></a>
