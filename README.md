...
1.  [pyim 使用说明](#orga16fa8b)
    ...
    7.  [配置](#org3a3ebe8)
        1.  [配置实例](#org691eef6)
        2.  [添加词库文件](#orgc22c331)
        3.  [激活 pyim](#org2f50538)
    8.  [使用](#orgd15ffc3)
        1.  [常用快捷键](#org7a741cf)
        2.  [使用双拼模式](#orgaa9c3fd)
        3.  [通过 pyim 来支持 rime 所有输入法](#orge2c633c)
        4.  [使用五笔输入](#org2568dcd)
        5.  [使用仓颉输入法](#org399bec6)
        6.  [让选词框跟随光标](#org39d146b)
        7.  [调整 tooltip 选词框的显示样式](#org4f58d5f)
        8.  [设置模糊音](#orgf4a0c13)
        9.  [使用魔术转换器](#org404e0cf)
        10. [切换全角标点与半角标点](#orgd2c6b38)
        11. [手动加词和删词](#org2ddd67e)
        12. [pyim 高级功能](#orgf31333d)
    9.  [捐赠](#org272570f)
    10. [Tips](#org08ef01b)
        1.  [如何将个人词条相关信息导入和导出？](#orgbbf01f0)
        2.  [pyim 出现错误时，如何开启 debug 模式](#orged1c37d)
        3.  [如何查看 pyim 文档。](#org6d330af)
        4.  [将光标处的拼音或者五笔字符串转换为中文 (与 vimim 的 “点石成金” 功能类似)](#orgd053b8c)
        5.  [如何添加自定义拼音词库](#org404408e)
        6.  [如何手动安装和管理词库](#org0c2f679)
        7.  [Emacs 启动时加载 pyim 词库](#orgc1d1132)
        8.  [将汉字字符串转换为拼音字符串](#orgc1631cc)
        9.  [中文分词](#org335dd3a)
        10. [获取光标处的中文词条](#org5fd0651)
        11. [让 \`forward-word' 和 \`back-backward’ 在中文环境下正常工作](#orgbdafe7f)
        12. [为 isearch 相关命令添加拼音搜索支持](#org4e4f8c5)
...
如果 pyim-basedict 不能满足需求，用户可以使用其他方式为 pyim 添加拼音词库，具体方式请参考 [1.10.5](#org404408e) 小结。
