...
1.  [pyim 使用说明](#orgfeeb67d)
    ...
    7.  [配置](#orge47c338)
        1.  [配置实例](#org9e39887)
        2.  [添加词库文件](#org2068c92)
        3.  [激活 pyim](#orgffb684e)
    8.  [使用](#orgc260bfb)
        1.  [常用快捷键](#orgb2c9d4e)
        2.  [使用双拼模式](#org2eea829)
        3.  [通过 pyim 来支持 rime 所有输入法](#org8cbd6d7)
        4.  [使用五笔输入](#org5aac030)
        5.  [使用仓颉输入法](#org10b37b3)
        6.  [让选词框跟随光标](#org88099c9)
        7.  [调整 tooltip 选词框的显示样式](#orgc50e2b1)
        8.  [设置模糊音](#org359917a)
        9.  [使用魔术转换器](#orgc930a63)
        10. [切换全角标点与半角标点](#orgc9b8cf0)
        11. [手动加词和删词](#orge431283)
        12. [pyim 高级功能](#orgc684955)
    9.  [捐赠](#org027c7c8)
    10. [Tips](#org1fecd2f)
        1.  [如何将个人词条相关信息导入和导出？](#orgead9d22)
        2.  [pyim 出现错误时，如何开启 debug 模式](#org1a03412)
        3.  [如何查看 pyim 文档。](#org3601c88)
        4.  [将光标处的拼音或者五笔字符串转换为中文 (与 vimim 的 “点石成金” 功能类似)](#orgfa51114)
        5.  [如何添加自定义拼音词库](#orga842f4d)
        6.  [如何手动安装和管理词库](#orgb924fde)
        7.  [Emacs 启动时加载 pyim 词库](#org1540889)
        8.  [将汉字字符串转换为拼音字符串](#org690619b)
        9.  [中文分词](#org090b553)
        10. [获取光标处的中文词条](#orga7b299f)
        11. [让 \`forward-word' 和 \`back-backward’ 在中文环境下正常工作](#org7cf4feb)
        12. [为 isearch 相关命令添加拼音搜索支持](#org7331185)
...
如果 pyim-basedict 不能满足需求，用户可以使用其他方式为 pyim 添加拼音词库，具体方式请参考 [1.10.5](#orga842f4d) 小结。
