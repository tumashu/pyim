...
1.  [pyim 使用说明](#orgdb020ca)
    ...
    7.  [配置](#org281b845)
        1.  [配置实例](#org51dd4c4)
        2.  [添加词库文件](#orgb0c36cb)
        3.  [激活 pyim](#org60c54c1)
    8.  [使用](#org0add281)
        1.  [常用快捷键](#org0fd4a68)
        2.  [使用双拼模式](#org548ca3a)
        3.  [通过 pyim 来支持 rime 所有输入法](#org82f25df)
        4.  [使用五笔输入](#orgf355db1)
        5.  [使用仓颉输入法](#org83e1841)
        6.  [让选词框跟随光标](#org0bee289)
        7.  [调整 tooltip 选词框的显示样式](#orgd033335)
        8.  [设置模糊音](#org81c32c0)
        9.  [使用魔术转换器](#org3e13ca2)
        10. [切换全角标点与半角标点](#orgbfdb39d)
        11. [手动加词和删词](#orgbe073fb)
        12. [pyim 高级功能](#org62c2cf4)
    9.  [捐赠](#org97a9178)
    10. [Tips](#org25203a0)
        1.  [如何将个人词条相关信息导入和导出？](#org2ad33bd)
        2.  [pyim 出现错误时，如何开启 debug 模式](#org14ff77e)
        3.  [如何查看 pyim 文档。](#org966d0fa)
        4.  [将光标处的拼音或者五笔字符串转换为中文 (与 vimim 的 “点石成金” 功能类似)](#org73d3101)
        5.  [如何添加自定义拼音词库](#org5c6e4f6)
        6.  [如何手动安装和管理词库](#org41c1d97)
        7.  [Emacs 启动时加载 pyim 词库](#org7ff3621)
        8.  [将汉字字符串转换为拼音字符串](#orge8ce462)
        9.  [中文分词](#org2904daf)
        10. [获取光标处的中文词条](#orge93f1fd)
        11. [让 \`forward-word' 和 \`back-backward’ 在中文环境下正常工作](#orgf1ce49a)
        12. [为 isearch 相关命令添加拼音搜索支持](#orgabf8aa3)
...
如果 pyim-basedict 不能满足需求，用户可以使用其他方式为 pyim 添加拼音词库，具体方式请参考 [1.10.5](#org5c6e4f6) 小结。
