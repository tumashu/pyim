...
## 配置<a id="org87331b3"></a>

### 配置实例<a id="orgece4fa5"></a>
...
### 添加词库文件<a id="orgcc7aa79"></a>

用户可以使用三种方法为 Chinese-pyim 添加拼音词库，具体方式请参考 [1.10.5](#org1d5a4ab) 小结。
...
### 激活 Chinese-pyim<a id="org4655de9"></a>

    (setq default-input-method "chinese-pyim")
    (global-set-key (kbd "C-\\") 'toggle-input-method)

## 使用<a id="org81a7956"></a>

### 常用快捷键<a id="orgc644d96"></a>
...
### 调整 tooltip 选词框的显示样式<a id="orgecc7f99"></a>
...
### 设置模糊音<a id="org53761de"></a>

可以通过设置 \`pyim-fuzzy-pinyin-alist' 变量来自定义模糊音。

### 词语联想<a id="org4450e18"></a>
...
### Chinese-pyim 高级功能<a id="org173bec4"></a>
...
## Tips<a id="orgf186b97"></a>

### Chinese-pyim 出现错误时，如何开启 debug 模式<a id="org433cdad"></a>

    (setq debug-on-error t)

### 选词框弹出位置不合理或者选词框内容显示不全<a id="org6644e55"></a>
...
### 将汉字字符串转换为拼音字符串<a id="orgba818f1"></a>
...
### 为 isearch 相关命令添加拼音搜索支持<a id="orgee5a4b3"></a>
...
### 使用 Chinese-pyim 改善 company-mode 中文补全的体验<a id="orgdc000ac"></a>
