...
1.  [pyim 使用说明](#orgda3a417)
    ...
    7.  [配置](#org30be2c4)
        1.  [配置实例](#org7f1da7f)
        2.  [添加词库文件](#org9772de3)
        3.  [激活 pyim](#org7bd6124)
    8.  [使用](#org4b62cb0)
        1.  [常用快捷键](#orgd51c7a4)
        2.  [使用双拼模式](#orga1f2b01)
        3.  [通过 pyim 来支持 rime 所有输入法](#org7cf778f)
        4.  [使用五笔输入](#org547e79c)
        5.  [使用仓颉输入法](#orgb035525)
        6.  [让选词框跟随光标](#org99a6313)
        7.  [调整 tooltip 选词框的显示样式](#org5817ba2)
        8.  [设置模糊音](#org849a7f2)
        9.  [使用魔术转换器](#orge090b93)
        10. [切换全角标点与半角标点](#org7d0e78e)
        11. [手动加词和删词](#orgffc3309)
        12. [pyim 高级功能](#orgd7ebf1d)
    9.  [捐赠](#org6ac375f)
    10. [Tips](#orgf22a5c6)
        1.  [关闭输入联想词功能 (默认开启)](#org9b72659)
        2.  [如何将个人词条相关信息导入和导出？](#org9bfdd93)
        3.  [pyim 出现错误时，如何开启 debug 模式](#orgeff37df)
        4.  [如何查看 pyim 文档。](#org9b9a3cb)
        5.  [将光标处的拼音或者五笔字符串转换为中文 (与 vimim 的 “点石成金” 功能类似)](#org4732a7d)
        6.  [如何使用其它字符翻页](#org4e83cdf)
        7.  [如何用 ";" 来选择第二个候选词](#org19fc110)
        8.  [如何添加自定义拼音词库](#org9b404e8)
        9.  [如何手动安装和管理词库](#org64b0a0e)
        10. [Emacs 启动时加载 pyim 词库](#org2697d9b)
        11. [将汉字字符串转换为拼音字符串](#orga776036)
        12. [中文分词](#org6e7e245)
        13. [获取光标处的中文词条](#org5bfaad4)
        14. [让 \`forward-word' 和 \`back-backward’ 在中文环境下正常工作](#orgb93d2a1)
        15. [为 isearch 相关命令添加拼音搜索支持](#orge00b3b0)
...
如果 pyim-basedict 不能满足需求，用户可以使用其他方式为 pyim 添加拼音词库，具体方式请参考 [1.10.8](#org9b404e8) 小结。
...
1.  安裝配置 liberime 和 pyim, 方式见：[liberime](https://github.com/merrickluo/liberime).
    注意，由于特殊的集成方式，pyim 通过变量 \`pyim-liberime-search-limit' 来限制从 rime 获取的词条数量，以提高输入法响应速度，用户可以根据自己设备的性能来灵活调整这个选项。
