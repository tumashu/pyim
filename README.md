- [Chinese-pyim 使用说明](#chinese-pyim-使用说明)
  ...
  - [捐赠](#捐赠)
  - [Tips](#tips)
    - [如何为 Chinese-pyim 贡献词条](#如何为-chinese-pyim-贡献词条)
...
如果 chinese-pyim-greatdict 不能满足需求，用户可以使用其他方式为 Chinese-pyim 添加拼音词库，具体方式请参考 [1.10.6](#orgheadline8) 小结。
...
### 如何手动安装和管理词库<a id="orgheadline34"></a>
...
### 如何合并两个词库文件<a id="orgheadline35"></a>
