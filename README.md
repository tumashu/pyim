- [Chinese-pyim 使用说明](#sec-1)
  ...
  - [使用](#sec-1-7)
    ...
    - [[实验特性] 词语联想](#sec-1-7-6)
  - [Tips](#sec-1-8)
    - [如何查看 Chinese-pyim 文档。](#sec-1-8-1)
...
## 背景<a id="sec-1-2" name="sec-1-2"></a>
...
## 目标<a id="sec-1-3" name="sec-1-3"></a>
...
## 配置<a id="sec-1-6" name="sec-1-6"></a>

### 添加词库文件<a id="sec-1-6-1" name="sec-1-6-1"></a>

用户可以使用三种方法为 Chinese-pyim 添加拼音词库，具体方式请参考 1.8.2 小结。
...
## 使用<a id="sec-1-7" name="sec-1-7"></a>

### 常用快捷键<a id="sec-1-7-1" name="sec-1-7-1"></a>
...
### 手动加词和删词<a id="sec-1-7-4" name="sec-1-7-4"></a>
...
### 快速切换词库<a id="sec-1-7-5" name="sec-1-7-5"></a>
...
### [实验特性] 词语联想<a id="sec-1-7-6" name="sec-1-7-6"></a>
...
## Tips<a id="sec-1-8" name="sec-1-8"></a>

### 如何查看 Chinese-pyim 文档。<a id="sec-1-8-1" name="sec-1-8-1"></a>

Chinese-pyim 开发使用 lentic 文学编程模式，代码文档隐藏在comment中，如果用户喜欢阅读 html 格式的文档，可以使用下面的命令：

    M-x pyim-devtools-view-devel-document

### 如何添加自定义拼音词库<a id="sec-1-8-2" name="sec-1-8-2"></a>
...
1.  第一种方式
    ...
    下载上述词库后，运行 \`pyim-add-dict' ，按照命令提示，将下载得到的词库文件信息添加到 \`pyim-dicts' 中，最后运行命令 \`pyim-restart' 或者重启
...
### 如何手动安装和管理词库<a id="sec-1-8-3" name="sec-1-8-3"></a>
...
### 将汉字字符串转换为拼音字符串<a id="sec-1-8-4" name="sec-1-8-4"></a>
