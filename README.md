...
1.  [pyim 使用说明](#org6b8b8f3)
    ...
    7.  [配置](#org90ea6db)
        1.  [配置实例](#orgcc1705f)
        2.  [添加词库文件](#orgce11fd9)
        3.  [激活 pyim](#org8cfa79c)
    8.  [使用](#org549dcf0)
        1.  [常用快捷键](#orgbad71dd)
        2.  [使用双拼模式](#org8814e7f)
        3.  [通过 pyim 来支持 rime 所有输入法](#orgcd0ef19)
        4.  [使用五笔输入](#orgb670103)
        5.  [使用仓颉输入法](#org6dfcae0)
        6.  [让选词框跟随光标](#org9c0956e)
        7.  [调整 tooltip 选词框的显示样式](#org5cd45b4)
        8.  [设置模糊音](#org506dff8)
        9.  [使用魔术转换器](#orgdae7b94)
        10. [切换全角标点与半角标点](#org32adaff)
        11. [手动加词和删词](#orge2f706e)
        12. [pyim 高级功能](#org79e7d21)
    9.  [捐赠](#orgde0440a)
    10. [Tips](#orgce23d6e)
        1.  [关闭输入联想词功能 (默认开启)](#org4106870)
        2.  [如何将个人词条相关信息导入和导出？](#orgd369501)
        3.  [pyim 出现错误时，如何开启 debug 模式](#orgb8cf2c9)
        4.  [如何查看 pyim 文档。](#org13057a1)
        5.  [将光标处的拼音或者五笔字符串转换为中文 (与 vimim 的 “点石成金” 功能类似)](#orgc23c9f7)
        6.  [如何使用其它字符翻页](#org366ed57)
        7.  [如何用 ";" 来选择第二个候选词](#org869b4ce)
        8.  [如何添加自定义拼音词库](#org0e08da6)
        9.  [如何手动安装和管理词库](#org40ed727)
        10. [Emacs 启动时加载 pyim 词库](#org293f944)
        11. [将汉字字符串转换为拼音字符串](#org5dad92e)
        12. [中文分词](#org355e0cc)
        13. [获取光标处的中文词条](#org2ec0683)
        14. [让 \`forward-word' 和 \`back-backward’ 在中文环境下正常工作](#org9dde187)
        15. [为 isearch 相关命令添加拼音搜索支持](#orgfc4ac02)
...
如果 pyim-basedict 不能满足需求，用户可以使用其他方式为 pyim 添加拼音词库，具体方式请参考 [1.10.8](#org0e08da6) 小结。
...
5.  如果通过 rime 使用微软双拼，自带的 rime 和 rime-quanqin scheme 都无法处理 ; 的输入，可以用以下设置：
