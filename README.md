...
## 配置<a id="orga53aed0"></a>

### 配置实例<a id="org6224a53"></a>
...
如果 chinese-pyim-greatdict 不能满足需求，用户可以使用其他方式为 Chinese-pyim 添加拼音词库，具体方式请参考 [1.10.5](#org4998b48) 小结。

### 激活 Chinese-pyim<a id="org8caa5b1"></a>

    (setq default-input-method "chinese-pyim")
    (global-set-key (kbd "C-\\") 'toggle-input-method)

## 使用<a id="org72fdaf9"></a>

### 常用快捷键<a id="orge8d1e5a"></a>
...
### 调整 tooltip 选词框的显示样式<a id="org09c610d"></a>
...
### 设置模糊音<a id="org3b7bb30"></a>

可以通过设置 \`pyim-fuzzy-pinyin-alist' 变量来自定义模糊音。

### 词语联想<a id="org7c5d095"></a>
...
### Chinese-pyim 高级功能<a id="org300cb2d"></a>
...
## Tips<a id="org0b90f83"></a>

### Chinese-pyim 出现错误时，如何开启 debug 模式<a id="org52877a6"></a>

    (setq debug-on-error t)

### 选词框弹出位置不合理或者选词框内容显示不全<a id="org0e4f712"></a>
...
### 将汉字字符串转换为拼音字符串<a id="org5750b7a"></a>
...
### 为 isearch 相关命令添加拼音搜索支持<a id="orgce58ba7"></a>
...
### 使用 Chinese-pyim 改善 company-mode 中文补全的体验<a id="orga82ac81"></a>
