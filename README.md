...
1.  [pyim 使用说明](#orgf43ba24)
    ...
    7.  [配置](#org01b20ed)
        1.  [配置实例](#org44314e7)
        2.  [添加词库文件](#org29459ab)
        3.  [激活 pyim](#org8886819)
    8.  [使用](#org9c37a5b)
        1.  [常用快捷键](#org3227e64)
        2.  [使用双拼模式](#orgeab2f60)
        3.  [使用五笔输入](#orgbce82c9)
        4.  [使用仓颉输入法](#org56cd9af)
        5.  [让选词框跟随光标](#orga2ae2f7)
        6.  [调整 tooltip 选词框的显示样式](#org293f277)
        7.  [设置模糊音](#orgb941b9d)
        8.  [切换全角标点与半角标点](#org0057ee9)
        9.  [手动加词和删词](#org5ca175d)
        10. [pyim 高级功能](#orgdd31e5a)
    9.  [捐赠](#orgac43f3a)
    10. [Tips](#orgfc4ac4c)
        1.  [如何将个人词条导出到一个文件](#org2ee2fdb)
        2.  [pyim 出现错误时，如何开启 debug 模式](#org506ba9b)
        3.  [选词框弹出位置不合理或者选词框内容显示不全](#orgd1a3d1a)
        4.  [如何查看 pyim 文档。](#orga536176)
        5.  [将光标处的拼音或者五笔字符串转换为中文 (与 vimim 的 “点石成金” 功能类似)](#org8d6a627)
        6.  [如何添加自定义拼音词库](#orgeb5ce75)
        7.  [如何手动安装和管理词库](#org108eac1)
        8.  [Emacs 启动时加载 pyim 词库](#org9689e1c)
        9.  [将汉字字符串转换为拼音字符串](#org0fa060d)
        10. [中文分词](#org4eb39c1)
        11. [获取光标处的中文词条](#orga4e2df9)
        12. [让 \`forward-word' 和 \`back-backward’ 在中文环境下正常工作](#orgc543a4f)
        13. [为 isearch 相关命令添加拼音搜索支持](#org82f67f1)
...
如果 pyim-basedict 不能满足需求，用户可以使用其他方式为 pyim 添加拼音词库，具体方式请参考 [1.10.6](#orgeb5ce75) 小结。
