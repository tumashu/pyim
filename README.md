...
1.  [pyim 使用说明](#org384ac05)
    ...
    7.  [配置](#orgc17345d)
        1.  [配置实例](#org9112478)
        2.  [添加词库文件](#org2fc7cd1)
        3.  [激活 pyim](#orgb9c276e)
    8.  [使用](#org67bb56e)
        1.  [常用快捷键](#org8ad3c35)
        2.  [使用双拼模式](#orgb925404)
        3.  [使用五笔输入](#org27e5667)
        4.  [使用仓颉输入法](#orgd039880)
        5.  [让选词框跟随光标](#org88d427d)
        6.  [调整 tooltip 选词框的显示样式](#org5e26817)
        7.  [设置模糊音](#orgc002bbc)
        8.  [切换全角标点与半角标点](#org8e71d08)
        9.  [手动加词和删词](#orgd48786e)
        10. [pyim 高级功能](#org19db66f)
    9.  [捐赠](#orgdddda60)
    10. [Tips](#orgea454e4)
        1.  [如何将个人词条导出到一个文件](#orga62b80c)
        2.  [pyim 出现错误时，如何开启 debug 模式](#org550ebe7)
        3.  [选词框弹出位置不合理或者选词框内容显示不全](#org3a68556)
        4.  [如何查看 pyim 文档。](#org886d16a)
        5.  [将光标处的拼音或者五笔字符串转换为中文 (与 vimim 的 “点石成金” 功能类似)](#orgab9efa0)
        6.  [如何添加自定义拼音词库](#org1086d02)
        7.  [如何手动安装和管理词库](#orga0242ee)
        8.  [Emacs 启动时加载 pyim 词库](#org253bbdc)
        9.  [将汉字字符串转换为拼音字符串](#org29a8af3)
        10. [中文分词](#orgf73fba1)
        11. [获取光标处的中文词条](#org429e3cc)
        12. [让 \`forward-word' 和 \`back-backward’ 在中文环境下正常工作](#orgd534146)
        13. [为 isearch 相关命令添加拼音搜索支持](#org35be170)
...
如果 pyim-basedict 不能满足需求，用户可以使用其他方式为 pyim 添加拼音词库，具体方式请参考 [1.10.6](#org1086d02) 小结。
