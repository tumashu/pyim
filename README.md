...
1.  [pyim 使用说明](#org0978484)
    ...
    7.  [配置](#org50d2021)
        1.  [配置实例](#orge7ce9ca)
        2.  [添加词库文件](#org571f198)
        3.  [激活 pyim](#org3ed2e8e)
    8.  [使用](#org9d17456)
        1.  [常用快捷键](#orgd3ad4b2)
        2.  [使用双拼模式](#orga6e72cb)
        3.  [通过 pyim 来支持 rime 所有输入法](#orgacc1cc2)
        4.  [使用五笔输入](#org348f076)
        5.  [使用仓颉输入法](#org76cc21d)
        6.  [让选词框跟随光标](#org51460c9)
        7.  [调整 tooltip 选词框的显示样式](#org85c56e8)
        8.  [设置模糊音](#orgcf405ee)
        9.  [使用魔术转换器](#org7e0ca88)
        10. [切换全角标点与半角标点](#orgb299699)
        11. [手动加词和删词](#org2e4e17e)
        12. [pyim 高级功能](#org3b3907c)
    9.  [捐赠](#org8bd087a)
    10. [Tips](#orgc6c67ba)
        1.  [关闭输入联想词功能 (默认开启)](#orgce48f94)
        2.  [如何将个人词条相关信息导入和导出？](#org76dab78)
        3.  [pyim 出现错误时，如何开启 debug 模式](#org9761015)
        4.  [如何查看 pyim 文档。](#orgc673c89)
        5.  [将光标处的拼音或者五笔字符串转换为中文 (与 vimim 的 “点石成金” 功能类似)](#org3bedfb6)
        6.  [如何使用其它字符翻页](#orgbd30048)
        7.  [如何用 ";" 来选择第二个候选词](#orgafc5c59)
        8.  [如何添加自定义拼音词库](#org7ed175d)
        9.  [如何手动安装和管理词库](#orge072a2e)
        10. [Emacs 启动时加载 pyim 词库](#org3ad458c)
        11. [将汉字字符串转换为拼音字符串](#org7a00886)
        12. [中文分词](#orgfcddada)
        13. [获取光标处的中文词条](#org3220e6b)
        14. [让 \`forward-word' 和 \`back-backward’ 在中文环境下正常工作](#org906328f)
        15. [为 isearch 相关命令添加拼音搜索支持](#orgf44c7b6)
...
如果 pyim-basedict 不能满足需求，用户可以使用其他方式为 pyim 添加拼音词库，具体方式请参考 [1.10.8](#org7ed175d) 小结。
