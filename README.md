...
1.  [pyim 使用说明](#org22a2273)
    ...
    7.  [配置](#org4c72037)
        1.  [配置实例](#org292f693)
        2.  [添加词库文件](#org882013f)
        3.  [激活 pyim](#org0b28543)
    8.  [使用](#orge095bad)
        1.  [常用快捷键](#orgbfccf3b)
        2.  [使用双拼模式](#org2c2e398)
        3.  [让 pyim 使用 rime (实验特性)](#org8f11986)
        4.  [使用五笔输入](#org95dab70)
        5.  [使用仓颉输入法](#orgcebd351)
        6.  [让选词框跟随光标](#org930bf9c)
        7.  [调整 tooltip 选词框的显示样式](#org66d63a4)
        8.  [设置模糊音](#org8642174)
        9.  [使用魔术转换器](#org84daef4)
        10. [切换全角标点与半角标点](#org9e55f08)
        11. [手动加词和删词](#orgd0c52f2)
        12. [pyim 高级功能](#orgde725c5)
    9.  [捐赠](#org80575a2)
    10. [Tips](#orgfac0596)
        1.  [如何将个人词条导出到一个文件](#org2991b14)
        2.  [pyim 出现错误时，如何开启 debug 模式](#org731baf4)
        3.  [如何查看 pyim 文档。](#orgf2f423e)
        4.  [将光标处的拼音或者五笔字符串转换为中文 (与 vimim 的 “点石成金” 功能类似)](#org8c694eb)
        5.  [如何添加自定义拼音词库](#orgd2d0420)
        6.  [如何手动安装和管理词库](#org371be39)
        7.  [Emacs 启动时加载 pyim 词库](#org9765f70)
        8.  [将汉字字符串转换为拼音字符串](#org0a6377b)
        9.  [中文分词](#orgce7e986)
        10. [获取光标处的中文词条](#orgc69c620)
        11. [让 \`forward-word' 和 \`back-backward’ 在中文环境下正常工作](#org4c1d840)
        12. [为 isearch 相关命令添加拼音搜索支持](#org094cf3d)
...
如果 pyim-basedict 不能满足需求，用户可以使用其他方式为 pyim 添加拼音词库，具体方式请参考 [1.10.5](#orgd2d0420) 小结。
