...
;;   开发动力，最终的结果就是：chinese-eim 在 2008 年之后几乎停止了开发。
;; 
...
;; 
;;   所以，本人认为将 Chinese-eim 作为一个 *备用* 中文输入法是非常合适的，
;;   于是我 fork 了emacs-eim, 简化代码并更改名称为：chinese-pyim。
;; 
;; 
;; 3 目标
;; ======
...
;; ~~~~~~~~~~~~~~~~
;; 
;;   可以使用三种方法为 Chinese-pyim 添加词库，具体方式请参考 “Tips:如何添
;;   加自定义词库” 章节。
;; 
