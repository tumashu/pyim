...
(ert-deftest pyim-tests-pyim-candidates-get-dcache-words ()
  (let* ((pyim-dhashcache-code2word (make-hash-table :test #'equal))
    ...
    (puthash "ni-hao" (list "你好" "尼耗") pyim-dhashcache-code2word)
    (puthash "n-h" (list "你好" "你坏" "尼耗" "南好" "内核" "内河") pyim-dhashcache-ishortcode2word)
    (should (equal (pyim-tests-sublists (pyim-candidates-dcache-quanpin-words imobjs1 quanpin nil) 10)
                   '(("你" "您" "妮") nil nil ("南" "乃" "囊" "脑" "呢" "内" "嫩" "能" "你" "年"))))
    (should (equal (pyim-tests-sublists (pyim-candidates-dcache-quanpin-words imobjs2 quanpin nil) 10)
                   '(("你" "尼") ("尼" "你") ("你" "尼" "呢" "泥" "拟" "逆" "倪" "妮" "腻" "匿") nil)))
    (should (equal (pyim-tests-sublists (pyim-candidates-dcache-quanpin-words imobjs3 quanpin nil) 10)
...
(ert-deftest pyim-tests-pyim-candidates-quanpin-first-chars ()
  (let* ((pyim-dhashcache-icode2word (make-hash-table :test #'equal))
    ...
    (puthash "ni" (list "你" "尼") pyim-dhashcache-code2word)
    (should (equal (pyim-tests-sublist (pyim-candidates-quanpin-first-chars (car imobjs) quanpin) 10)
                   '("你" "呢" "尼" "泥" "拟" "逆" "倪" "妮" "腻" "匿")))))
