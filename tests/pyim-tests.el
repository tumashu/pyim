...
(ert-deftest pyim-tests-pyim-candidates-get-dcache-words ()
  (let* ((pyim-dhashcache-code2word (make-hash-table :test #'equal))
    ...
    (puthash "ni-hao" (list "你好" "尼耗") pyim-dhashcache-code2word)
    (puthash "n-h" (list "你好" "你坏" "尼耗" "南好" "内核" "内河") pyim-dhashcache-ishortcode2word)
    (should (equal (pyim-candidates-create-get-dcache-words imobjs1 quanpin nil t)
                   '(("你" "您" "妮") nil nil nil)))
    (should (equal (pyim-candidates-create-get-dcache-words imobjs2 quanpin nil t)
                   '(nil ("你好" "尼耗") ("你好" "尼耗") nil)))
    (should (equal (pyim-candidates-create-get-dcache-words imobjs3 quanpin nil t)
                   '(("你" "尼") ("你" "尼") ("你" "尼" "你" "尼") nil)))))
